...
import { IgxButtonDirective, IgxRippleDirective, IgxToggleDirective, IgxToggleActionDirective, IgxOverlayOutletDirective, IGX_BUTTON_GROUP_DIRECTIVES, IGX_CHIPS_DIRECTIVES, IGX_INPUT_GROUP_DIRECTIVES, IgxIconComponent, IgxSwitchComponent, IgxRadioComponent, IgxRadioGroupDirective, IgxIconButtonDirective, IgcFormsModule, IgxAvatarComponent, IgxBadgeComponent, IGX_TREE_DIRECTIVES, IGX_BANNER_DIRECTIVES, IGX_DIALOG_DIRECTIVES, IGX_CARD_DIRECTIVES, IGX_TABS_DIRECTIVES, IGX_STEPPER_DIRECTIVES, IGX_SELECT_DIRECTIVES, IGX_DATE_PICKER_DIRECTIVES, IGX_SLIDER_DIRECTIVES, IGX_CALENDAR_DIRECTIVES, IgxSnackbarComponent } from 'igniteui-angular';
